  ...
  methods: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])({
    ...
    Login: function Login() {
      ...
      this.signIn(this.form).then(function () {
        ...
        _this.$vs.notify({
          title: _this.$t("Error"),
          text: _this.$t("WrongUsernamePassword"),
          iconPack: 'feather',
      ...
      }, 1000); // If user is already logged in notify
                        ...
                        _c(
                          ...
                          [
                            _c("div", { staticClass: "vx-card__title mb-4" }, [
                              ...
                              _vm._v(" "),
                              _c("p", [_vm._v(_vm._s(_vm.$t("LoginMessage")))])
                            ]),
                            _vm._v(" "),
                            _c("login-jwt")
                          ],
          ...
          _c(
            "vs-checkbox",
            {
              ...
              model: {
                ...
                callback: function($$v) {
                  _vm.$set(_vm.form, "checkbox_remember_me", $$v)
                },
                expression: "form.checkbox_remember_me"
              }
            },
